...
{
    return mock().actualCall("gpio_enable_module").returnUnsignedIntValue();
}
...
int32_t adcifb_configure(volatile avr32_adcifb_t *adcifb, const adcifb_opt_t *p_adcifb_opt)
{
    ...
    return mock().actualCall("adcifb_configure").returnIntValue();
}

int32_t adcifb_configure_trigger(volatile avr32_adcifb_t *adcifb, uint8_t trgmod, uint32_t trgper)
{
    CHECK(adcifb != NULL);
    return mock().actualCall("adcifb_configure_trigger").returnIntValue();
}

bool adcifb_is_ready(volatile avr32_adcifb_t *adcifb)
{
    CHECK(adcifb != NULL);
    return mock().actualCall("adcifb_is_ready").returnBoolValue();
}

bool adcifb_is_drdy(volatile avr32_adcifb_t *adcifb)
{
    CHECK(adcifb != NULL);
    return mock().actualCall("adcifb_is_drdy").returnBoolValue();
}

uint32_t adcifb_get_last_data(volatile avr32_adcifb_t *adcifb)
{
    CHECK(adcifb != NULL);
    return mock().actualCall("adcifb_get_last_data").returnUnsignedIntValue();
}
...
TEST(HalAdcTests, InitAdcCallsFunctions)
{
    ...
    mock().expectOneCall("adcifb_configure").andReturnValue(PASS);
    mock().expectOneCall("adcifb_configure_trigger").andReturnValue(PASS);
    init_adc_at32uc3l0256();
}
...
TEST(HalAdcTests, InitAdcConfigFailureCallsRuntimeError)
{
    mock().expectOneCall("sysclk_init");
    mock().expectOneCall("gpio_enable_module").andReturnValue(GPIO_SUCCESS);
    mock().expectOneCall("adcifb_configure").andReturnValue(FAIL);
    mock().expectOneCall("RUNTIME_ERROR")
            .withUnsignedIntParameter("timestamp", 0)
...
TEST(HalAdcTests, InitAdcConfigTriggerFailureCallsRuntimeError)
{
    ...
    mock().expectOneCall("gpio_enable_module").andReturnValue(GPIO_SUCCESS);
    mock().expectOneCall("adcifb_configure").andReturnValue(PASS);
    mock().expectOneCall("adcifb_configure_trigger").andReturnValue(FAIL);
    mock().expectOneCall("RUNTIME_ERROR")
            .withUnsignedIntParameter("timestamp", 0)
...
TEST(HalAdcTests, ReadAdcCallsFunctions)
{
    ...
    mock().expectOneCall("adcifb_is_ready").andReturnValue(true);
    mock().expectOneCall("RUNTIME_TELEMETRY")
            .withUnsignedIntParameter("timestamp", 0)
            .withStringParameter("fail_message",
                                 "enable adc channel: adcifb_is_ready() passed watchdog")
            .withUnsignedIntParameter("fail_value", 0);
    mock().expectOneCall("adcifb_is_drdy").andReturnValue(true);
    mock().expectOneCall("RUNTIME_TELEMETRY")
            .withUnsignedIntParameter("timestamp", 0)
            .withStringParameter("fail_message",
                                 "start adc conversion: adcifb_is_drdy() passed watchdog")
            .withUnsignedIntParameter("fail_value", 0);
    mock().expectOneCall("adcifb_get_last_data").andReturnValue(1023);
    read_adc_channel_at32uc3l0256(&ir_sensor_1);
}
...
TEST(HalAdcTests, ReadAdcAdcifbIsReadyWatchdogFailureCallsRuntimeError)
{
    ...
    mock().expectNCalls(WATCHDOG_MAX + 1, "adcifb_is_ready").andReturnValue(false);
    mock().expectOneCall("RUNTIME_ERROR")
            .withUnsignedIntParameter("timestamp", 0)
            .withStringParameter("fail_message",
                                 "enable adc channel: adcifb_is_ready() failed watchdog")
...
TEST(HalAdcTests, ReadAdcAdcifbIsDrdyWatchdogFailureCallsRuntimeError)
{
    ...
    mock().expectOneCall("RUNTIME_TELEMETRY")
            ...
            .withStringParameter("fail_message",
                                 "enable adc channel: adcifb_is_ready() passed watchdog")
            .withUnsignedIntParameter("fail_value", 0);
    mock().expectNCalls(WATCHDOG_MAX + 1, "adcifb_is_drdy").andReturnValue(false);
    mock().expectOneCall("RUNTIME_ERROR")
            .withUnsignedIntParameter("timestamp", 0)
            .withStringParameter("fail_message",
                                 "start adc conversion: adcifb_is_drdy() failed watchdog")
            .withUnsignedIntParameter("fail_value", WATCHDOG_MAX);
    read_adc_channel_at32uc3l0256(&ir_sensor_1);
}
